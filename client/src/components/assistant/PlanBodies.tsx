 ...
 * tool's own tagline, and a free/paid label. Nothing here is written by the
 * model: `action` comes from the server's STAGE_ACTIONS map and the tagline
 * and pricing label are read straight off the hydrated tool.
 */
